# Dossier — AP_REDO_017 (BEHAVIORAL)

**Claim (this audit tests):** 0x11: RedoAddSchema

**Canonical claim (reference_table.csv):** Application: 0x11: RedoAddSchema
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_017.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_017.csv` (matrix) — 
