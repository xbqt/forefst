# Dossier — AP_REDO_026 (BEHAVIORAL)

**Claim (this audit tests):** 0x1A: RedoAddCompressionUnitOffsets (v3.4) / RedoGhostExtents (v3.14)

**Canonical claim (reference_table.csv):** Application: 0x1A: RedoAddCompressionUnitOffsets (v3.4) / RedoGhostExtents (v3.14)
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_026.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_026.csv` (matrix) — 
