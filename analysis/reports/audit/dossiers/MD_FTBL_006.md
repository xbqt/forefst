# Dossier — MD_FTBL_006 (BEHAVIORAL)
...
- N/A
- SecurityId at $SI+0x28 (resolves in OID 0x530, E19). Field-role claim cited.

## Raw-disk proof
- probe `cite` ; validation matrix: `proofs/validation/MD_FTBL_006.csv`
- corrected registry note: (none)

## Proof links
- `proofs/validation/MD_FTBL_006.csv` (matrix) — 
