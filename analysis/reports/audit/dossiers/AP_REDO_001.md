# Dossier — AP_REDO_001 (BEHAVIORAL)

**Claim (this audit tests):** 0x00: OpenTable (v3.4) / OpenTableFromTablePath (v3.14)

**Canonical claim (reference_table.csv):** Application: 0x00: OpenTable (v3.4) / OpenTableFromTablePath (v3.14)
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_001.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_001.csv` (matrix) — 
