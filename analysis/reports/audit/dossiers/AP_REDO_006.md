# Dossier — AP_REDO_006 (BEHAVIORAL)

**Claim (this audit tests):** 0x05: RedoReparentTable

**Canonical claim (reference_table.csv):** Application: 0x05: RedoReparentTable
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_006.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_006.csv` (matrix) — 
