# Dossier — AP_REDO_028 (BEHAVIORAL)

**Claim (this audit tests):** 0x1C: RedoCompactionUnreserve

**Canonical claim (reference_table.csv):** Application: 0x1C: RedoCompactionUnreserve
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_028.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_028.csv` (matrix) — 
