# Dossier — AP_REDO_034 (BEHAVIORAL)

**Claim (this audit tests):** 0x23: RedoTableSetShadowTreeUpdate (v3.14 only)

**Canonical claim (reference_table.csv):** Application: 0x23: RedoTableSetShadowTreeUpdate (v3.14 only)
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_034.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_034.csv` (matrix) — 
