# Dossier — AP_REDO_002 (BEHAVIORAL)

**Claim (this audit tests):** 0x01: RedoInsertRow

**Canonical claim (reference_table.csv):** Application: 0x01: RedoInsertRow
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_002.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_002.csv` (matrix) — 
