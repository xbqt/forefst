# Dossier — AP_REDO_014 (BEHAVIORAL)

**Claim (this audit tests):** 0x0E: RedoSetParentId

**Canonical claim (reference_table.csv):** Application: 0x0E: RedoSetParentId
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_014.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_014.csv` (matrix) — 
