# Dossier — AP_REDO_010 (BEHAVIORAL)

**Claim (this audit tests):** 0x0A: RedoDuplicateExtents

**Canonical claim (reference_table.csv):** Application: 0x0A: RedoDuplicateExtents
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_010.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_010.csv` (matrix) — 
