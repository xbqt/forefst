# Dossier — AP_REDO_016 (BEHAVIORAL)

**Claim (this audit tests):** 0x10: CmsBPlusTable::SetObjectRecordPayload (v3.4 only — gap in v3.14)

**Canonical claim (reference_table.csv):** Application: 0x10: CmsBPlusTable::SetObjectRecordPayload (v3.4 only — gap in v3.14)
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_016.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_016.csv` (matrix) — 
