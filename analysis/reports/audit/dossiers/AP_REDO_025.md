# Dossier — AP_REDO_025 (BEHAVIORAL)

**Claim (this audit tests):** 0x19: RedoDeleteCompressionUnitOffsets

**Canonical claim (reference_table.csv):** Application: 0x19: RedoDeleteCompressionUnitOffsets
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_025.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_025.csv` (matrix) — 
