# Dossier — AP_REDO_007 (BEHAVIORAL)

**Claim (this audit tests):** 0x06: RedoAllocate

**Canonical claim (reference_table.csv):** Application: 0x06: RedoAllocate
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_007.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_007.csv` (matrix) — 
