# Dossier — AP_REDO_030 (BEHAVIORAL)

**Claim (this audit tests):** 0x1E: RedoUpdateStreamSummary (v3.14 only)

**Canonical claim (reference_table.csv):** Application: 0x1E: RedoUpdateStreamSummary (v3.14 only)
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_030.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_030.csv` (matrix) — 
