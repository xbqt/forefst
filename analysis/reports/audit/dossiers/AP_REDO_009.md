# Dossier — AP_REDO_009 (BEHAVIORAL)

**Claim (this audit tests):** 0x08-0x09: RedoSetRangeState (v3.14 only — gap in v3.4)

**Canonical claim (reference_table.csv):** Application: 0x08-0x09: RedoSetRangeState (v3.14 only — gap in v3.4)
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_009.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_009.csv` (matrix) — 
