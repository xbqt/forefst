# Dossier — AP_REDO_005 (BEHAVIORAL)

**Claim (this audit tests):** 0x04: RedoUpdateDataWithRoot (v3.4 only — gap in v3.14)

**Canonical claim (reference_table.csv):** Application: 0x04: RedoUpdateDataWithRoot (v3.4 only — gap in v3.14)
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_005.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_005.csv` (matrix) — 
