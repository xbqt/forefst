# Dossier — AP_REDO_004 (BEHAVIORAL)

**Claim (this audit tests):** 0x03: RedoUpdateRow

**Canonical claim (reference_table.csv):** Application: 0x03: RedoUpdateRow
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_004.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_004.csv` (matrix) — 
