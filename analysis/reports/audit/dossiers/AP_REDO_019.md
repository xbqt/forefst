# Dossier — AP_REDO_019 (BEHAVIORAL)

**Claim (this audit tests):** 0x13: RedoAddContainer

**Canonical claim (reference_table.csv):** Application: 0x13: RedoAddContainer
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_019.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_019.csv` (matrix) — 
