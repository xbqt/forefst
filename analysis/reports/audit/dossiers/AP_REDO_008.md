# Dossier — AP_REDO_008 (BEHAVIORAL)

**Claim (this audit tests):** 0x07: RedoFree

**Canonical claim (reference_table.csv):** Application: 0x07: RedoFree
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_008.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_008.csv` (matrix) — 
