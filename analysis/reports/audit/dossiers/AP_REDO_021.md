# Dossier — AP_REDO_021 (BEHAVIORAL)

**Claim (this audit tests):** 0x15: RedoMoveContainer goto (v3.4) / dispatch flag (v3.14)

**Canonical claim (reference_table.csv):** Application: 0x15: RedoMoveContainer goto (v3.4) / dispatch flag (v3.14)
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_021.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_021.csv` (matrix) — 
