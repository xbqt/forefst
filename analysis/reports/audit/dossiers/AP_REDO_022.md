# Dossier — AP_REDO_022 (BEHAVIORAL)

**Claim (this audit tests):** 0x16: RedoReadCacheInvalidation (v3.4) / RedoSetRangeState (v3.14)

**Canonical claim (reference_table.csv):** Application: 0x16: RedoReadCacheInvalidation (v3.4) / RedoSetRangeState (v3.14)
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_022.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_022.csv` (matrix) — 
