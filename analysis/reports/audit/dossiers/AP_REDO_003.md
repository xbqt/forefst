# Dossier — AP_REDO_003 (BEHAVIORAL)

**Claim (this audit tests):** 0x02: RedoDeleteRow

**Canonical claim (reference_table.csv):** Application: 0x02: RedoDeleteRow
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_003.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_003.csv` (matrix) — 
