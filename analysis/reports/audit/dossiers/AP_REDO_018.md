# Dossier — AP_REDO_018 (BEHAVIORAL)

**Claim (this audit tests):** 0x12: RedoMoveContainer

**Canonical claim (reference_table.csv):** Application: 0x12: RedoMoveContainer
...
## Raw-disk proof
- probe `static_dossier` ; validation matrix: `proofs/validation/AP_REDO_018.csv`
- corrected registry note: (none)

## Proof links
- `proofs/static/PerformRedo__decomp.txt` (static) — PerformRedo
- `proofs/validation/AP_REDO_018.csv` (matrix) — 
