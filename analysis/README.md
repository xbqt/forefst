...
| Path | What it holds |
|------|---------------|
| [`reference_table.csv`](reference_table.csv) | The central claim register — 435 structural claims, each with a raw-disk verification status and an evidence level. **This is the live reference.** |
