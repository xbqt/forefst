...
hard-link pair (**FN_LINK_003 / E59**). Findings: **MD_SI_RA_012, MD_SI_SA_001, MD_SI_SA_002, FN_LINK_002, FN_LINK_003, MD_INTG_RA_001**. The remaining field-level statements on this page are registered as **FN_DTBL_001**, **MD_DDIR_001–004**, **MD_SI_RA_004**, **MD_SI_RA_005**, **MD_SI_RA_011**, **MD_SI_RA_014**, **MD_TS_RA_001**, **MD_TS_RA_002** — each with its own evidence tier and witness in the claim register. Prior work tabulated these fields **twice** — once as a *File Table* and once as a *Directory Descriptor* — and both sets describe this one structure, since a file's `$SI` and a directory's `$SI` share the layout: **MD_FTBL_001–004**, **MD_FTBL_006** duplicate **MD_DDIR_001–004**, **MD_DDIR_006**. Both are kept in the register because each records a distinct source table. See [how this was verified](../methodology.md).
