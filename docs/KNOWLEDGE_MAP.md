...
| [EA_INFORMATION.md](attributes/EA_INFORMATION.md) | Extended attributes (EAs) on ReFS are a two-part structure: $EA_INFORMATION (embedded type … | FS_REPS_RA_002, FS_REPS_RA_003, MD_ATTR_RA_010, MD_ATTR_RA_011, MD_ATTR_RA_012 |
| [EFS.md](attributes/EFS.md) | $EFS is the Windows Encrypting File System metadata for an encrypted file. | MD_ATTR_RA_009, MD_EFS_RA_005 |
...
| [NAMED_DATA.md](attributes/NAMED_DATA.md) | $NAMED_DATA is ReFS's named (alternate) data stream — ADS. | FS_SNAP_RA_001, MD_SNAP_RA_005 |
| [OBJ_LINK.md](attributes/OBJ_LINK.md) | $OBJ_LINK is the object → name backpointer — it stores a filename and its parent OID directly in the … | — |
...
| [REPARSE_POINT.md](attributes/REPARSE_POINT.md) | $REPARSE_POINT stores the inline REPARSE_DATA_BUFFER for a reparse point — a symlink, junction … | FS_REPS_RA_002, FS_REPS_RA_003, MD_ATTR_RA_010, MD_ATTR_RA_012 |
| [SNAPSHOT.md](attributes/SNAPSHOT.md) | $SNAPSHOT is the per-stream snapshot metadata for file versioning (embedded type 0xB0, schema … | CT_DRNT_RA_001, FS_SNAP_RA_001, GN_SNAP_SA_001, MD_SNAP_RA_002, MD_SNAP_RA_003, MD_SNAP_RA_005, MD_SNAP_RA_010 |
| [STANDARD_INFORMATION.md](attributes/STANDARD_INFORMATION.md) | $STANDARD_INFORMATION ($SI) is the most forensically important attribute — every file and … | FN_LINK_002, FN_LINK_003, FS_SNAP_RA_001, MD_ATTR_RA_015, MD_INTG_RA_001, MD_SI_RA_012, MD_SI_SA_001, MD_SI_SA_002 |
| [VOLUME_INFORMATION.md](attributes/VOLUME_INFORMATION.md) | $VOLUME_INFORMATION (schema 0x150, embedded type 0x50) is the volume-level metadata — version … | FS_VOLI_RA_001 |

## 1. Pages in structures/

| Page | Topic | Findings cited on the page |
|------|-------|----------------------------|
| [allocators.md](structures/allocators.md) | ReFS tracks free and allocated clusters with a three-tier allocator hierarchy. | CT_ALLC_001, CT_ALLC_RA_001, FS_ALLOC_RA_001, FS_ALLOC_RA_002, FS_CHKP_010, GN_ALLC_SA_001, GN_ARCH_RA_001 |
| [block_refcount.md](structures/block_refcount.md) | The Block Refcount Table (root #6, table ID 0x05, schema 0xe0b0) tracks shared data clusters used by … | — |
| [btree_node.md](structures/btree_node.md) | All ReFS metadata is stored in B+-trees with the signature "MSB+". | GN_ARCH_001, GN_ARCH_005, GN_IDXR_004, GN_PAGE_007 |
| [chkp.md](structures/chkp.md) | The Checkpoint is the atomic commit point of a ReFS volume. A volume keeps two alternating checkpoints; | FS_CHKP_RA_001, FS_CHKP_RA_005, FS_CHKP_RA_012, FS_CHKP_RA_013 |
| [container_index.md](structures/container_index.md) | The Container Index (root #10, table ID 0x0E, schema 0xe100) is an alternate index over the … | — |
| [container_table.md](structures/container_table.md) | The Container Table (roots #7/#8, schema 0xe0c0) maps virtual container IDs to physical disk … | AP_REDO_037, CT_CTBL_001, CT_CTBL_RA_003, CT_CTBL_RA_004, FS_CHKP_016, FS_CHKP_017, GN_ARCH_003, GN_ARCH_RA_001 |
| [directory_entries.md](structures/directory_entries.md) | Directory entries (type 0x30) are B+-tree rows within a per-directory B+-tree. | GN_IENT_004 |
| [extent_descriptors.md](structures/extent_descriptors.md) | Extent descriptors (type 0x40) map a file's logical cluster offsets (VCNs) to virtual LCNs (VLCNs). | CT_DRNT_RA_001, MD_DATA_RA_001, MD_DATA_RA_002, MD_DATA_RA_007, MD_DATA_RA_009, MD_DATA_RA_011, MD_DATA_RA_013, MD_DATA_RA_014, MD_SNAP_RA_003 |
| [integrity_state.md](structures/integrity_state.md) | The Integrity State Table (root #11, table ID 0x0F, schema 0xe080) tracks volume-level … | — |
| [mlog.md](structures/mlog.md) | The MLog implements write-ahead logging for atomic metadata updates. | AP_LGFL_RA_008, AP_REDO_001 |
| [object_table.md](structures/object_table.md) | The Object Table (roots #0 and #5, schema 0xe030) is the master OID-to-table mapping. | — |
| [page_header.md](structures/page_header.md) | Every ReFS metadata page -- SUPB, CHKP, and MSB+ (B+-tree) -- begins with a common 80-byte header. | FS_SUPB_RA_001, GN_PAGE_001, GN_PAGE_007, GN_PAGE_RA_001, GN_PAGE_RA_002 |
| [page_references.md](structures/page_references.md) | A page reference binds a child page's address to a checksum of that child's contents. | FS_CHKP_004, FS_SUPB_006, FS_SUPB_RA_003, GN_PREF_002, GN_PREF_RA_004 |
| [parent_child_table.md](structures/parent_child_table.md) | The Parent-Child Table (root #4, schema 0xe040) encodes the directory hierarchy. | FS_OTBL_SA_010, FS_PCHL_001, FS_PCTB_RA_001 |
| [reparse_points.md](structures/reparse_points.md) | A reparse point is a per-file tag plus payload that redirects path resolution — a symlink, junction … | — |
| [reverse_index.md](structures/reverse_index.md) | Type 0x20 is the per-object FileId-resolution index: rows keyed by a FileId (object reference / child index) that let the driver, given… … | — |
| [schema_table.md](structures/schema_table.md) | The Schema Table (roots #3/#9, schema 0xe060) is self-describing: it contains one entry per table type used by the volume. | FN_LINK_003, FS_PCTB_RA_001, FS_SCHM_001, FS_SCHM_RA_005, FS_SCHM_RA_008, FS_SCHM_RA_010, FS_SECD_RA_003, MD_TS_RA_005, MD_UNSUP_RA_001 |
| [security_descriptors.md](structures/security_descriptors.md) | ReFS uses a centralized, content-addressed security model. | — |
| [supb.md](structures/supb.md) | The Superblock is the fixed-location volume anchor that points to the two alternating checkpoints. | FS_CHKP_005, FS_SUPB_001, FS_SUPB_005, FS_SUPB_007, FS_SUPB_RA_003 |
| [system_oids.md](structures/system_oids.md) | ReFS reserves the OIDs below 0x700 for internal use; user files and directories start at 0x701. | FS_OTBL_005, FS_OTBL_RA_001, FS_OTBL_RA_003, FS_OTBL_RA_005, FS_OTBL_SA_004, FS_OTBL_SA_005, FS_REPS_RA_001, FS_SCHM_RA_001, FS_SECD_RA_001, MD_SECT_001 |
| [trash_table.md](structures/trash_table.md) | The Trash Table (OID 0x0D, schema 0xe0d0) is an asynchronous deletion queue. | FS_OTBL_RA_008 |
| [upcase_table.md](structures/upcase_table.md) | The Upcase Table (OID 0x07 primary, OID 0x08 duplicate, schema 0xe090) stores the Unicode … | — |
| [usn_journal.md](structures/usn_journal.md) | The USN (Update Sequence Number) Journal records every change to files and directories on the … | AP_CHJN_001, FS_OTBL_005, MD_SI_RA_013, MD_SI_RA_015, MD_USN_RA_001, MD_USN_RA_002, MD_USN_RA_003, MD_USN_RA_004, MD_USN_RA_008, MD_USN_RA_009 |
| [vbr.md](structures/vbr.md) | The VBR is a 512-byte structure at sector 0 of the ReFS partition. | GN_PREF_002 |
| [volume_info.md](structures/volume_info.md) | The Volume Information table (OID 0x500 primary, OID 0x501 duplicate, schema 0x150) stores the volume … | — |
...
| [architecture.md](concepts/architecture.md) | The single most useful fact for anyone parsing ReFS is that the driver is built in two layers, and only … | GN_ARCH_001, GN_ARCH_002 |
| [artifact_timeline.md](concepts/artifact_timeline.md) | Time is the spine of most filesystem investigations, and ReFS scatters it across five … | FN_LINK_003 |
| [attributes.md](concepts/attributes.md) | In NTFS every piece of a file — its name, its timestamps, its data, its security — is an attribute … | FS_SCHM_RA_005, FS_SNAP_RA_001, MD_ATTR_005, MD_ATTR_RA_003, MD_ATTR_RA_019, MD_DDIR_005 |
...
| [carrier_categories.md](concepts/carrier_categories.md) | Brian Carrier's File System Forensic Analysis organises every file-system artifact into five … | AP_LGFL_005, AP_REDO_001, FN_LINK_002, FS_CHKP_RA_014, FS_DEL_RA_002, FS_DEL_RA_005, MD_SI_RA_008, MD_SI_RA_009, MD_SI_RA_010 |
| [checksum_architecture.md](concepts/checksum_architecture.md) | ReFS protects its metadata with a Merkle-tree variant: every B+-tree parent stores a checksum of each … | FS_CHKP_005, FS_SUPB_001, FS_SUPB_005, FS_SUPB_007, FS_SUPB_RA_003, GN_PREF_002 |
...
| [compression.md](concepts/compression.md) | ReFS compression is the feature most likely to make a file's bytes on disk look like noise to a … | AP_REDO_026, AP_REDO_037, CT_COMP_RA_001, CT_COMP_RA_002, GN_COMP_SA_001 |
| [copy_on_write.md](concepts/copy_on_write.md) | Copy-on-write is the rule that makes ReFS recoverable: no metadata page is ever overwritten in … | AP_LGFL_005, GN_ARCH_002 |
| [deduplication.md](concepts/deduplication.md) | Deduplication is the one ReFS feature that deliberately stores file content with no live file pointing … | CT_BKRC_001, FS_CHKP_015, FS_CHKP_RA_001 |
| [deletion_recovery.md](concepts/deletion_recovery.md) | When a file is deleted on ReFS, the question for an analyst is not whether an entry was scrubbed in … | FS_CHKP_RA_014, FS_DEL_RA_005, MD_DEL_RA_004 |
| [driver_architecture.md](concepts/driver_architecture.md) | The on-disk structures only tell half the story; the other half is the code that writes them. | — |
| [driver_transitions.md](concepts/driver_transitions.md) | Two different things get called "making a file non-resident", and they are decided by different code in … | FS_MOVE_RA_002, FS_RESD_SA_001, FS_RESD_SA_002, GN_VCB_SA_001, MD_ADS_RA_003, MD_DATA_RA_025 |
| [file_ids.md](concepts/file_ids.md) | A ReFS file has no Object ID of its own (that identifier belongs to directories and system tables — see … | FN_LINK_002, MD_SI_RA_008, MD_SI_RA_010, MD_USN_RA_001, MD_USN_RA_002, MD_USN_RA_005 |
| [file_systems.md](concepts/file_systems.md) | Every ReFS forensic decision rests on a small number of general file-system ideas — what a cluster is … | — |
| [forensic_analysis_workflow.md](concepts/forensic_analysis_workflow.md) | This is the end-to-end runbook for examining a ReFS volume: a fixed, ordered triage that takes an … | FN_LINK_003, FS_CHKP_005, FS_CHKP_RA_001, FS_CHKP_RA_012, FS_CHKP_RA_013, FS_CHKP_RA_014, FS_DEL_RA_005, FS_SUPB_001, FS_SUPB_005, FS_SUPB_007, FS_SUPB_RA_003 |
| [hard_links.md](concepts/hard_links.md) | A hard link is a second (or third, ...) directory name that points at one physical file. | FN_LINK_002, FN_LINK_003, FS_OTBL_RA_008, MD_DATA_RA_004, MD_DATA_RA_006, MD_SI_RA_001, MD_SI_RA_009 |
| [integrity_streams.md](concepts/integrity_streams.md) | An integrity stream is a per-file, opt-in feature that protects a file's data with per-block … | CT_INTS_001, CT_INTS_002, GN_PREF_002, MD_DATA_RA_010, MD_DATA_RA_013, MD_INTG_RA_001 |
...
| [object_ids.md](concepts/object_ids.md) | Every persistent ReFS directory or system table carries a 64-bit Object ID (OID). | FS_OTBL_RA_006, FS_OTBL_SA_004, FS_OTBL_SA_005, FS_OTBL_SA_009 |
...
| [placement_and_residency.md](concepts/placement_and_residency.md) | ReFS answers two questions about every file, and they are independent. | MD_DATA_RA_015, MD_PLAC_RA_001 |
| [redundancy.md](concepts/redundancy.md) | Every ReFS volume keeps redundant copies of the three structures it needs to mount — the … | FS_CHKP_005, FS_CHKP_RA_014, FS_SUPB_001, FS_SUPB_005, FS_SUPB_007, FS_SUPB_RA_003, FS_VBR_RA_013 |
| [resident_storage.md](concepts/resident_storage.md) | The single most consequential question a ReFS recovery tool can get wrong is where a file's bytes … | — |
| [snapshots_versioning.md](concepts/snapshots_versioning.md) | A ReFS stream snapshot freezes a file's current content under a new stream identity, so that later … | AP_LGFL_005, CT_BKRC_001, CT_DRNT_RA_001, FS_CHKP_015, FS_OTBL_RA_008, FS_SCHM_RA_005, FS_SCHM_RA_008, FS_SNAP_RA_001, GN_ARCH_002, GN_SNAP_SA_001, MD_ATTR_RA_018, MD_SNAP_RA_002, MD_SNAP_RA_003, MD_SNAP_RA_005, MD_SNAP_RA_006, MD_SNAP_RA_007 |
...
| [timestomp_detection.md](concepts/timestomp_detection.md) | Timestomping — back-dating a file's timestamps to hide when it was really created or written — is a … | MD_SNAP_RA_010, MD_TS_RA_009 |
...
| [transactions_crash_consistency.md](concepts/transactions_crash_consistency.md) | ReFS keeps its metadata consistent across power loss with two cooperating mechanisms: a redo-only … | AP_LGFL_001, AP_LGFL_002, AP_LGFL_005, AP_LGFL_RA_004, AP_LGFL_RA_007, AP_LGFL_RA_008, AP_LGFL_RA_009, AP_REDO_001, FS_DEL_RA_001 |
| [version_detection.md](concepts/version_detection.md) | A ReFS volume's version is a parsing precondition, not a label you can read once and set aside. | FS_CHKP_RA_001, FS_CHKP_RA_013 |
...
| [virtual_addressing.md](concepts/virtual_addressing.md) | Virtual addressing is the rule that decides where ReFS data actually lives on disk, and it is the first … | — |
| [what_survives.md](concepts/what_survives.md) | On a ReFS volume the analyst's first question is rarely how is this structure laid … | AP_LGFL_005, AP_LGFL_RA_004, AP_LGFL_RA_008, CT_DRNT_RA_001, FS_CHKP_RA_014, FS_DEL_RA_005, FS_OTBL_RA_008, FS_SECD_RA_001, FS_VBR_RA_013, GN_SNAP_SA_001, MD_SNAP_RA_002, MD_SNAP_RA_003 |
| [windows_file_systems.md](concepts/windows_file_systems.md) | Before a single ReFS byte is ever read off disk, the volume has already passed through half a dozen … | — |
| [wsl_metadata.md](concepts/wsl_metadata.md) | When the Windows Subsystem for Linux (WSL) accesses a ReFS volume through a DrvFs mount with … | — |
...
**81 rows with more than one page** are the owner-page consolidation candidates: one
...
| `AP_REDO_026` | E2 | NOT_TESTED |  | [compression.md](concepts/compression.md) |
| `AP_REDO_037` | E2 | NOT_TESTED | 3 | [compression.md](concepts/compression.md), [ntfs_comparison.md](concepts/ntfs_comparison.md), [container_table.md](structures/container_table.md) |
...
| `CT_CNTX_001` | — | CONFIRMED |  | [tool_artifact_map.md](concepts/tool_artifact_map.md) |
...
| `CT_CTBL_002` | — | CONFIRMED |  | [cluster_page_size.md](concepts/cluster_page_size.md) |
| `CT_CTBL_003` | — | CONFIRMED |  | [cluster_page_size.md](concepts/cluster_page_size.md) |
...
The triage list: **303 of 482** register rows are cited by no page in
...
| Finding | Static | Disk |
|---------|--------|------|
| `GN_PAGE_002` | — | CONFIRMED |
| `GN_PAGE_003` | — | CONFIRMED |
| `GN_PAGE_004` | — | INFERRED |
| `GN_PAGE_005` | — | INFERRED |
| `GN_PAGE_006` | — | CONFIRMED |
| `GN_PREF_003` | — | CONFIRMED |
| `GN_IDXR_001` | E2 | CONFIRMED |
| `GN_IDXR_002` | E2 | CONFIRMED |
| `GN_IDXR_003` | E2 | CONFIRMED |
| `GN_IDXH_001` | — | CONFIRMED |
| `GN_IDXH_002` | — | ENRICHED |
| `GN_IDXH_003` | — | CONFIRMED |
| `GN_IENT_001` | — | CONFIRMED |
| `GN_IENT_002` | — | CONFIRMED |
| `GN_IENT_003` | — | CONFIRMED |
| `GN_IENT_005` | — | CONFIRMED |
| `GN_IENT_006` | — | CONFIRMED |
| `FS_VBR_001` | E2 … | CONFIRMED |
| `FS_VBR_002` | E2 | CONFIRMED |
| `FS_VBR_003` | E2 … | CONFIRMED |
| `FS_VBR_004` | — | CONFIRMED |
| `FS_VBR_005` | — | CONFIRMED |
| `FS_VBR_006` | E2 … | CONFIRMED |
| `FS_VBR_007` | E2 … | CONFIRMED |
| `FS_VBR_009` | E2 … | CONFIRMED |
| `FS_VBR_010` | E2 … | CONFIRMED |
| `FS_VBR_012` | E2 … | CONTRADICTED |
| `FS_VBR_013` | E2 … | NOT_TESTED |
| `FS_SUPB_002` | — | CONFIRMED |
| `FS_SUPB_003` | — | CONFIRMED |
| `FS_SUPB_004` | — | CONFIRMED |
| `FS_CHKP_001` | E1 | CONFIRMED |
| `FS_CHKP_002` | — | CONFIRMED |
| `FS_CHKP_003` | — | CONFIRMED |
| `FS_CHKP_006` | — | CONFIRMED |
| `FS_CHKP_007` | E2 | INFERRED |
| `FS_CHKP_008` | — | CONFIRMED |
| `FS_CHKP_011` | — | CONFIRMED |
| `FS_CHKP_013` | E2 | CONFIRMED |
| `FS_CHKP_019` | — | CONFIRMED |
| `FS_CHKP_020` | E2 | CONFIRMED |
| `FS_CHKP_021` | — | CONFIRMED |
| `FS_OTBL_001` | E2 | CONFIRMED |
| `FS_OTBL_002` | — | ENRICHED |
| `FS_OTBL_003` | — | CONFIRMED |
| `FS_OTBL_004` | — | CONFIRMED |
| `FS_VINF_001` | E1 | CONFIRMED |
| `FS_VINF_002` | — | CONFIRMED |
| `FS_VINF_003` | — | CONTRADICTED |
| `CT_ALLC_002` | E2 … | CONFIRMED |
| `CT_ALLC_003` | E2 | ENRICHED |
| `CT_CTBL_004` | — | CONFIRMED |
| `CT_CTBL_005` | — | INFERRED |
| `CT_CTBL_006` | — | CONTRADICTED |
| `CT_CTBL_007` | — | CONFIRMED |
| `CT_CTBL_008` | — | INFERRED |
| `CT_CTBL_009` | — | CONFIRMED |
| `CT_CTBL_010` | — | CONTRADICTED |
| `CT_CTBL_011` | — | CONTRADICTED |
| `CT_DRNT_001` | E2 | NOT_TESTED |
| `CT_DRNT_002` | — | CONTRADICTED |
| `CT_DRNT_003` | — | CONFIRMED |
| `CT_DRNT_004` | E2 | NOT_TESTED |
| `CT_MISC_001` | E2 | CONFIRMED |
| `CT_MISC_002` | E2 | NOT_TESTED |
| `MD_DDIR_001` | E2 | CONFIRMED |
| `MD_DDIR_002` | — | CONFIRMED |
| `MD_DDIR_003` | — | NOT_TESTED |
| `MD_DDIR_004` | — | NOT_TESTED |
| `MD_DDIR_006` | — | NOT_TESTED |
| `MD_FTBL_001` | — | CONFIRMED |
| `MD_FTBL_002` | — | CONFIRMED |
| `MD_FTBL_003` | — | NOT_TESTED |
| `MD_FTBL_004` | — | NOT_TESTED |
| `MD_FTBL_005` | — | CONFIRMED |
| `MD_FTBL_006` | — | NOT_TESTED |
| `MD_FTBL_007` | E2 | CONFIRMED |
| `MD_ATTR_001` | E2 … | INFERRED |
| `MD_ATTR_002` | E1 … | CONFIRMED |
| `MD_ATTR_003` | E1 … | CONFIRMED |
| `MD_ATTR_004` | E1 | NOT_TESTED |
| `MD_ATTR_006` | E1 | CONFIRMED |
| `MD_ATTR_007` | E1 … | INFERRED |
| `MD_ATTR_008` | E1 | CONFIRMED |
| `MD_ATTR_009` | — | INFERRED |
| `MD_MISC_001` | — | NOT_TESTED |
| `MD_MISC_002` | — | NOT_TESTED |
| `FN_DTBL_001` | — | INFERRED |
| `FN_DTBL_002` | — | ENRICHED |
| `FN_DTBL_003` | E2+RD | INFERRED |
| `FN_DTBL_004` | E1 | INFERRED |
| `FN_ADDR_001` | — | CONFIRMED |
| `FN_PATH_001` | E2 | CONFIRMED |
| `FN_LINK_001` | E2 | INFERRED |
| `AP_LGTB_001` | — | CONFIRMED |
| `AP_LGTB_002` | — | CONFIRMED |
| `AP_LGTB_003` | — | CONFIRMED |
| `AP_LGTB_005` | — | CONFIRMED |
| `AP_LGFL_003` | E2 | CONFIRMED |
| `AP_LGFL_004` | — | CONFIRMED |
| `AP_REDO_002` | E2 | NOT_TESTED |
| `AP_REDO_003` | E2 | NOT_TESTED |
| `AP_REDO_004` | E2 | NOT_TESTED |
| `AP_REDO_005` | E2 | NOT_TESTED |
| `AP_REDO_006` | E2 | NOT_TESTED |
| `AP_REDO_007` | E2 | NOT_TESTED |
| `AP_REDO_008` | E2 | NOT_TESTED |
| `AP_REDO_009` | E2 | NOT_TESTED |
| `AP_REDO_010` | E2 | NOT_TESTED |
| `AP_REDO_011` | E2 | NOT_TESTED |
| `AP_REDO_012` | E2 | NOT_TESTED |
| `AP_REDO_013` | E2 | NOT_TESTED |
| `AP_REDO_014` | E2 | NOT_TESTED |
| `AP_REDO_015` | E2 | NOT_TESTED |
| `AP_REDO_016` | E2 | NOT_TESTED |
| `AP_REDO_017` | E2 | NOT_TESTED |
| `AP_REDO_018` | E2 | NOT_TESTED |
| `AP_REDO_019` | E2 | NOT_TESTED |
| `AP_REDO_020` | E2 | NOT_TESTED |
| `AP_REDO_021` | E2 | NOT_TESTED |
| `AP_REDO_022` | E2 | NOT_TESTED |
| `AP_REDO_023` | E2 | NOT_TESTED |
| `AP_REDO_024` | E2 | NOT_TESTED |
| `AP_REDO_025` | E2 | NOT_TESTED |
| `AP_REDO_027` | E2 | NOT_TESTED |
| `AP_REDO_028` | E2 | NOT_TESTED |
| `AP_REDO_029` | E2 | NOT_TESTED |
| `AP_REDO_030` | E2 | NOT_TESTED |
| `AP_REDO_031` | E2 | NOT_TESTED |
| `AP_REDO_032` | E2 | NOT_TESTED |
| `AP_REDO_033` | E2 | NOT_TESTED |
| `AP_REDO_034` | E2 | NOT_TESTED |
| `AP_REDO_035` | E2 | NOT_TESTED |
| `AP_REDO_036` | E2 | NOT_TESTED |
| `AP_REDO_038` | E2 | NOT_TESTED |
| `AP_REDO_039` | E2 | NOT_TESTED |
| `AP_EVNT_001` | E2 | ENRICHED |
| `AP_EVNT_002` | E2 | CONFIRMED |
| `AP_EVNT_003` | — | NOT_TESTED |
| `AP_EVNT_004` | E2 | ENRICHED |
| `AP_EVNT_005` | E2 | CONFIRMED |
| `AP_EVNT_006` | E2 | ENRICHED |
| `AP_EVNT_007` | E2 | CONFIRMED |
| `AP_WIPE_001` | — | NOT_TESTED |
| `AP_CHJN_002` | — | CONFIRMED |
| `AP_CHJN_003` | — | NOT_TESTED |
| `AP_CHJN_004` | — | CONFIRMED |
| `GN_ARCH_SA_001` | E2 | NOT_TESTED |
| `GN_IRP_SA_001` | E2 | NOT_TESTED |
| `GN_HIER_SA_001` | E2 | NOT_TESTED |
| `GN_BIN_SA_001` | E2 | NOT_TESTED |
| `MD_ATTR_SA_001` | — | ENRICHED |
| `GN_AMGR_SA_001` | E2 | NOT_TESTED |
| `GN_EFS_SA_001` | E2 … | NOT_TESTED |
| `GN_HEAT_SA_001` | E2 … | NOT_TESTED |
| `GN_DEDUP_SA_001` | E2 … | INFERRED |
| `GN_WSL_SA_001` | — | NOT_TESTED |
| `GN_CROT_SA_001` | E2 … | NOT_TESTED |
| `GN_KSR_SA_001` | — | NOT_TESTED |
| `GN_FOPS_SA_001` | E2 | NOT_TESTED |
| `GN_FOPS_SA_002` | E2 | NOT_TESTED |
| `GN_INS_SA_001` | E2 … | NOT_TESTED |
| `GN_INS_SA_002` | E2 | NOT_TESTED |
| `GN_INS_SA_003` | E2 | NOT_TESTED |
| `GN_XVER_SA_001` | — | NOT_TESTED |
| `GN_IMP_SA_001` | E2 | NOT_TESTED |
| `GN_OOP_SA_001` | — | NOT_TESTED |
| `GN_UTIL_SA_001` | E2 … | NOT_TESTED |
| `FS_VBR_RA_002` | E2 … | CONFIRMED |
| `FS_CHKP_RA_002` | E2 | CONFIRMED |
| `AP_LGFL_RA_003` | E2 | CONFIRMED |
| `FS_VBR_RA_004` | E2 | CONFIRMED |
| `FS_VBR_RA_005` | — | INFERRED |
| `FS_VBR_RA_006` | — | INFERRED |
| `FS_VBR_RA_007` | — | INFERRED |
| `GN_ARCH_RA_002` | — | CONFIRMED |
| `MD_DATA_RA_003` | — | INFERRED |
| `FS_VINF_RA_001` | — | CONFIRMED |
| `GN_BPT_RA_001` | E2 | CONFIRMED |
| `GN_DTCT_RA_001` | E2 | CONFIRMED |
| `MD_ATTR_RA_004` | — | CONFIRMED |
| `AP_LGFL_RA_005` | E2 | CONFIRMED |
| `AP_LGFL_RA_006` | E2 | CONFIRMED |
| `FS_CHKP_RA_007` | E2 | CONFIRMED |
| `FS_CHKP_RA_008` | E1 | CONFIRMED |
| `FS_VBR_RA_009` | — | INFERRED |
| `FS_OTBL_RA_002` | E2 | NEW |
| `FS_OTBL_RA_004` | E2 | CONFIRMED |
| `FS_SCHM_RA_002` | E2 … | CONTRADICTED |
| `FS_SCHM_RA_003` | E2 … | CONFIRMED |
| `FS_SCHM_RA_006` | E2 | CONFIRMED |
| `FS_VBR_RA_010` | E2 … | CONFIRMED |
| `FS_CHKP_RA_011` | E2 | CONFIRMED |
| `FS_SUPB_RA_002` | — | CONFIRMED |
| `FS_SUPB_RA_004` | — | CONFIRMED |
| `FS_SUPB_RA_005` | — | CONFIRMED |
| `FS_SUPB_RA_006` | — | CONFIRMED |
| `MD_TS_RA_001` | — | CONFIRMED |
| `MD_TS_RA_002` | — | INFERRED |
| `MD_TS_RA_003` | — | CONFIRMED |
| `MD_TS_RA_004` | — | CONFIRMED |
| `MD_TS_RA_006` | — | CONFIRMED |
| `MD_SF_RA_001` | — | NEW |
| `MD_SF_RA_002` | — | NEW |
| `MD_SF_RA_004` | — | NEW |
| `MD_DEL_RA_001` | — | INFERRED |
| `MD_DEL_RA_002` | — | CONTRADICTED |
| `MD_DEL_RA_003` | — | INFERRED |
| `MD_EFS_RA_001` | — | NEW |
| `MD_EFS_RA_002` | — | NEW |
| `MD_EFS_RA_003` | — | NEW |
| `MD_CS_RA_001` | E2+RD | CORRECTED |
| `MD_CS_RA_002` | — | CORRECTED |
| `MD_LK_RA_001` | — | INFERRED |
| `MD_LK_RA_002` | — | NEW |
| `MD_LK_RA_003` | — | CONFIRMED |
| `MD_LK_RA_004` | — | INFERRED |
| `MD_SNAP_RA_001` | — | NEW |
| `MD_SNAP_RA_004` | — | NEW |
| `MD_ATTR_RA_001` | — | CONTRADICTED |
| `MD_ATTR_RA_002` | — | NEW |
| `MD_DISK_RA_006` | — | NEW |
| `MD_DISK_RA_008` | — | INFERRED |
| `MD_DISK_RA_009` | — | NEW |
| `FS_UPGD_RA_001` | — | NEW |
| `CT_BKRC_RA_001` | — | NEW |
| `FS_OTBL_RA_007` | — | NEW |
...
| `MD_DISK_RA_010` | — | CORRECTED |
| `FS_OTBL_SA_001` | E2 … | CONFIRMED |
| `FS_OTBL_SA_002` | E2 … | CONFIRMED |
| `FS_OTBL_SA_003` | E2 … | CONFIRMED |
| `FS_OTBL_SA_006` | E2 | CONFIRMED |
| `FS_OTBL_SA_007` | E2 | CONFIRMED |
| `FS_OTBL_SA_008` | E2 … | CONFIRMED |
| `GN_ARCH_SA_002` | E2 … | NOT_TESTED |
| `FS_VBR_SA_013` | E2 … | NOT_TESTED |
| `FN_OPEN_SA_001` | E2 | NOT_TESTED |
| `FS_SCHM_RA_009` | RD | CONFIRMED |
| `FN_DTBL_005` | E2+RD | CONFIRMED |
| `FN_DTBL_006` | E2+RD | CONFIRMED |
| `FS_VBR_RA_011` | RD | CONFIRMED |
| `FS_SCHM_RA_011` | RD | CONTRADICTED |
| `CT_BKRC_RA_002` | E2+RD | CONFIRMED |
| `AP_REDO_040` | RD | CONFIRMED |
| `FS_VBR_RA_012` | RD | CONFIRMED |
| `MD_SI_RA_004` | RD | CONFIRMED |
| `MD_ATTR_RA_005` | E2+RD | CONFIRMED |
| `MD_ATTR_RA_006` | E2+RD | CONFIRMED |
| `MD_LK_RA_005` | E2+RD | CONFIRMED |
| `MD_LK_RA_006` | E2+RD | CONFIRMED |
| `MD_ATTR_RA_007` | RD | CONFIRMED |
| `MD_ATTR_RA_008` | RD | CONFIRMED |
| `MD_LK_RA_007` | E2+RD | CONFIRMED |
| `MD_SI_RA_005` | E2+RD | CONFIRMED |
| `MD_SI_RA_006` | E2+RD | CONFIRMED |
| `MD_SI_RA_007` | E2+RD | CONFIRMED |
| `MD_SI_RA_011` | E2+RD | INFERRED |
| `MD_ATTR_RA_013` | RD | CONFIRMED |
| `MD_ATTR_RA_014` | E2+RD | CONFIRMED |
| `MD_EFS_RA_004` | E1+RD | CONFIRMED |
| `MD_LK_RA_008` | E2+RD | CONFIRMED |
| `MD_LK_RA_009` | E2+RD | CONFIRMED |
| `MD_ATTR_RA_016` | RD | CONFIRMED |
| `MD_SI_RA_014` | E2+RD | INFERRED |
| `GN_ARCH_006` | E2 | — |
| `CT_ALLC_004` | E2 | CONFIRMED |
| `FS_CHKP_RA_015` | E3 | CONFIRMED |
| `MD_DATA_RA_012` | E2+RD | CONFIRMED |
| `FS_REPS_RA_004` | E2+RD | CONFIRMED |
| `MD_USN_RA_006` | E2 | NEW |
| `FN_LINK_004` | E2 | NEW |
| `FS_MOVE_RA_001` | E2+RD | NEW |
| `MD_USN_RA_007` | RD | CONFIRMED |
| `MD_ATTR_RA_020` | E2+RD | CONFIRMED |
| `MD_ADS_RA_001` | RD | CONFIRMED |
| `MD_DATA_RA_021` | RD | CONFIRMED |
| `AP_LGFL_RA_010` | E2+RD | CONFIRMED |
| `FN_DTBL_007` | E2+RD | CONFIRMED |
| `FS_REPS_RA_005` | RD | CONFIRMED |
| `MD_DATA_RA_022` | E2+RD | CONFIRMED |
| `MD_SNAP_RA_008` | RD | CONFIRMED |
| `GN_TREE_RP_003` | RD | CONFIRMED |
| `MD_ADS_RA_002` | RD | CONFIRMED |
| `MD_DATA_RA_023` | RD | CONFIRMED |
| `MD_DATA_RA_024` | RD | CONFIRMED |
| `MD_DATA_RA_026` | RD | CONFIRMED |
| `MD_ADS_RA_004` | RD … | CONFIRMED |
| `MD_EFS_RA_006` | RD | CONFIRMED |
| `CT_COMP_RA_003` | E2+RD | CONFIRMED |
| `CT_BKRC_RA_003` | RD | CONFIRMED |
| `MD_TS_RA_007` | E2+RD | CONFIRMED |
| `GN_IMG_RA_001` | RD | CONFIRMED |
| `GN_IDENT_RA_001` | RD | CONFIRMED |
| `MD_INTG_RA_005` | RD | CONFIRMED |
| `MD_DATA_RA_027` | RD | REFUTED |
| `MD_ADS_RA_005` | RD | CONFIRMED |
| `FS_MOVE_RA_003` | RD | CONFIRMED |
| `MD_SNAP_RA_009` | RD | CONFIRMED |
| `MD_TS_RA_008` | E2+RD | CONFIRMED |
| `MD_SF_RA_005` | RD | CONFIRMED |

---
*Generated by `build_docs_index.py` — 81 pages indexed, 179 of 482 register rows cited, 81 cited on more than one page. The claim register is `analysis/reference_table.csv`.*
